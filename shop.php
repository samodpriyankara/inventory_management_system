                                    ...
                                    <div class="table-responsive border-bottom" style="padding: 10px;">
                                        ...
                                        <table class="table mb-0 thead-border-top-0" id="ShopTable">
                                            ...
                                            <tbody class="list">
                                                <?php
                                                    if($is_distributor){
                                                        $sql = "SELECT * FROM tbl_outlet tou INNER JOIN tbl_shop_category tsc ON tou.category=tsc.category_id INNER JOIN tbl_route tr ON tou.route_id=tr.route_id INNER JOIN tbl_distributor_has_route tdhr ON tou.route_id=tdhr.route_id WHERE tdhr.distributor_id='$user_id'";
                                                    }else{
                                                        $sql = "SELECT * FROM tbl_outlet tou INNER JOIN tbl_shop_category tsc ON tou.category=tsc.category_id INNER JOIN tbl_route tr ON tou.route_id=tr.route_id";
                                                    }
