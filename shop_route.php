                                ...
                                <div class="col-lg-12 card-form__body">
                                    ...
                                    <div class="border-bottom" style="padding: 10px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php
                                                if($is_distributor){
                                                    $Routesql = "SELECT * FROM tbl_route tr INNER JOIN tbl_distributor_has_route tdhr ON tr.route_id=tdhr.route_id WHERE distributor_id='$user_id' ORDER BY tr.route_id ASC";
                                                }else{
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-6">
                                              <a href="outlet_by_route?s=<?php echo base64_encode($RouteId); ?>" style="text-decoration: none;">
                                                  ...
                                                  <div class="row">
                                                    <div class="col-5 col-md-4">
                                                      <div class="icon-big text-center icon-warning">
                                                        <img src="assets/img/icons/shop.png" style="width: 100%;">
                                                      </div>
                                                    </div>
                                                    <div class="col-7 col-md-8">
                                                      <div class="numbers">
                                                        ...
                                                        <p class="card-title" style="font-weight: 600; color: #000; font-size: 20px; float: right;">
                                                          <?php
                                                            $OutletCountSQL = "SELECT COUNT(*) FROM tbl_outlet WHERE route_id='$RouteId'";
                                                            $OutletCountCountResult = mysqli_query($conn, $OutletCountSQL);
                                                            $RouteOutletCount = mysqli_fetch_assoc($OutletCountCountResult)['COUNT(*)'];
                                                            echo $RouteOutletCount;
                                                          ?>
                                                        <p>
                                                      </div>
                                                    </div>
