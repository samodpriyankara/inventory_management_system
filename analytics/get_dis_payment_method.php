  <?php
    ...
    if(isset($_POST['payment_summery_distributor_id']))
    {
        $payment_summery_distributor_id = htmlspecialchars($_POST['payment_summery_distributor_id']);

        //Cash Invoice
        $query="SELECT COUNT(*) FROM tbl_order WHERE distributor_id='$payment_summery_distributor_id' AND payment_method='0'";
        ...
        //Credit Invoice
        $query="SELECT COUNT(*) FROM tbl_order WHERE distributor_id='$payment_summery_distributor_id' AND payment_method='1'";
