                                        ...
                                        <table class="table mb-0 thead-border-top-0" id="ShopTable">
                                            ...
                                            <?php
                                                ...
                                                if($is_distributor){
                                                  ...
                                                  $CashInvoicesql = "SELECT * FROM tbl_order tor INNER JOIN tbl_route tro ON tor.route_id=tro.route_id INNER JOIN tbl_order_delivery tod ON tor.id=tod.order_id WHERE tor.distributor_id = '$user_id' AND tor.route_id='$RouteID' AND (tod.delivery_status='0' OR tod.delivery_status='1')";

                                                }else{
                                                  $CashInvoicesql = "SELECT * FROM tbl_order tor INNER JOIN tbl_route tro ON tor.route_id=tro.route_id INNER JOIN tbl_order_delivery tod ON tor.id=tod.order_id WHERE tor.route_id='$RouteID' AND (tod.delivery_status='0' OR tod.delivery_status='1')";
                                                }
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                    ...
                                                    <font style="font-weight: 700; color: #FF0000;">Still in stores</font>
                                                    <?php }elseif($DeliveryStatus=='1'){ ?>
                                                            <font style="font-weight: 700; color: #26580F;">Sent from stores</font>
                                                    <?php }else{ ?>
                                                        <font style="font-weight: 700; color: #26580F;">Delivered</font>
                                                    <?php } ?>
                                                  </td>
