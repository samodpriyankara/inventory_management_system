                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="pull-right" style="float: right;">
                                <a href="distributor" class="btn btn-primary">Register Distributor</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive border-bottom" style="padding: 10px;">
                                        ...
                                        <table class="table mb-0 thead-border-top-0" id="DistributorTable">
                                            ...
                                            <tbody class="list">
                                                ...
                                                ?>
                                                <tr>
                                                    <td style="display: none;"><?php echo $dis[0];?></td>
                                                    <td><?php echo $dis[1];?></td>
                                                    <td><?php echo $dis[2];?></td>
                                                    <td><?php echo $dis[3];?></td>
                                                    <td><a class="btn btn-secondary" href="view_distributor_stock?distributor=<?php echo base64_encode($dis[0]);?>">View Current Stock</a></td>
                                                    <td><a class="btn btn-dark" href="view_distributor_profile?d=<?php echo base64_encode($dis[0]);?>">View Profile</a></td>
                                                </tr>                      
                                                <?php } ?>
                                            </tbody>
                                        </table>
