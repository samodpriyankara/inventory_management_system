        ...
        <div class="mdk-drawer-layout__content">
            ...
            <div class="mdk-header-layout js-mdk-header-layout" data-has-scrolling-region>
                ...
                <div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h3>Sales-Rep Performence & Details</h3>
                        </div>
                        <!-- <div class="col-md-6">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-12 card-form__body">
                                    ...
                                    <div class="table-responsive border-bottom" style="padding: 10px;">
                                        ...
                                        <table class="table mb-0 thead-border-top-0" id="SalesRepTable">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Rep Name</th>
                                            ...
                                            <tbody class="list">
                                                <?php
                                                    ...
                                                    if($is_distributor){
                                                        $SalesRepSql = "SELECT * FROM tbl_user tu INNER JOIN tbl_distributor_has_tbl_user tdhu ON tu.id = tdhu.user_id WHERE tdhu.distributor_id = '$user_id' ORDER BY tu.id DESC";
                                                    }else{
                                                        $SalesRepSql = "SELECT * FROM tbl_user ORDER BY id DESC";
                                                    }

                                                    $SalesRepSqlrs=$conn->query($SalesRepSql);
                                                    while($RIrow=$SalesRepSqlrs->fetch_array())
                                                    {
                                                        $Id=$RIrow[0];                       
                                                        $RepName=$RIrow[1];   
                                                        $RepUserName=$RIrow[2];     
