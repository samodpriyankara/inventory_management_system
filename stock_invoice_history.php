                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-12 card-form__body">
                                    ...
                                    <div class="table-responsive border-bottom" style="padding: 10px;">
                                        ...
                                        <table class="table mb-0 thead-border-top-0" id="StockAddingTable">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                            ...
                                            <tbody class="list">
                                                <?php
                                                    ...
                                                    $StockAddListSql = "SELECT * FROM tbl_stock_add_details WHERE stat='1' ";
