<?php
    ...
    if($_POST)
    {
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////
          ...
          ///////////////////
          $sql = "UPDATE tbl_item SET `stock`= stock + '$qty' WHERE genaricName= '$item_id' AND itemId = '$price_batch_id' ";

          if ($conn->query($sql) === TRUE) {
            // echo "Record updated successfully";

            $AddGrnItemsql = "INSERT INTO `tbl_grn_items`(`grn_items_id`, `grn_detail_id`, `item_detail_id`, `price_batch_id`, `cost_price`, `selling_price`, `qty`, `stat`) VALUES (null, '$grn_detail_id', '$item_id', '$price_batch_id', '$cost_price', '$selling_price', '$qty', '$stat')";
