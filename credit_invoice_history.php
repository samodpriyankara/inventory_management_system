                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-12 card-form__body">
                                    ...
                                    <div class="table-responsive border-bottom" style="padding: 10px;">
                                        ...
                                        <table class="table mb-0 thead-border-top-0" id="CreditTable">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody class="list">
                                                <?php
                                                    if($is_distributor){
                                                      $CashInvoicesql = "SELECT * FROM tbl_order tor INNER JOIN tbl_route tro ON tor.route_id=tro.route_id WHERE tor.payment_method='2' AND tor.distributor_id = '$user_id' ";
                                                    }else{
                                                      $CashInvoicesql = "SELECT * FROM tbl_order tor INNER JOIN tbl_route tro ON tor.route_id=tro.route_id WHERE tor.payment_method='2' ";
