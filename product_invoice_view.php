                                ...
                                <div class="example-content">
                                    <table class="table table-hover">
                                        <thead>
                                            ...
                                            <th scope="col">
                                                <font style="float: right;">Price</font>
                                            </th>
                                            <th scope="col">
                                        ...
                                        <tbody id="grn-item-area">
                                            <?php
                                            $getDataQuery = $conn->query("SELECT toid.*, tod.* FROM tbl_order_item_details toid INNER JOIN tbl_order tod ON toid.order_id = tod.id WHERE toid.itemId = '$ProductId' ");
                                            while ($GRNrs = $getDataQuery->fetch_array()) {

                                                $ProductId = $GRNrs[1];
                                                $InvoiceId = $GRNrs[8];
                                                $InvoiceNumber = $GRNrs[9];
                                                $Qty = $GRNrs[3];
                                                $Price = $GRNrs[6];
                                                $total = $Qty * $Price;
                                            ...
                                            ?>
                                                <tr onclick="location.href='invoice?i=<?php echo (base64_encode($InvoiceId)); ?>'" style="cursor: pointer;">
